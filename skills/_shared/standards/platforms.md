...
description: >
  Особенности реализации компонентов на Web (React), iOS (SwiftUI) и
  Android (Compose): API props, токены, доступность, touch targets,
  кросс-платформенные слоты и обязательный чеклист интерактивности.
---
