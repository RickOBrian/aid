 ...
 *
 * Секретов в сборке нет. Раньше сюда подставлялся PLUGIN_SHARED_SECRET из
 * .env.local, но dist/code.js раздаётся публичным релизом — значит и ключ
 * читал любой, кто скачал архив. Теперь ключ вводится в настройках плагина.
 *
