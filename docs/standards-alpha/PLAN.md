...
| W0-5 | Единый шаблон гайда: шапка (версия, статус, дата, владелец), обязательный Changelog, порядок разделов | todo |
| W0-6 | Правило версий альфы: статус `alpha` в шапке каждого гайда ядра | todo |
...
| W3-5 | Расширить скилл `guide-lint`: живые ссылки, сходимость версий, расхождение терминов, соответствие .md ↔ .json | todo |
